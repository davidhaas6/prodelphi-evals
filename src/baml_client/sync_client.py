...
class BamlStreamClient:
    ...
    def EvalAdherence(
        ...
        character_description: str,interview: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[partial_types.AdherenceRubric, types.AdherenceRubric]:
      __tb__ = baml_options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      else:
      ...
      return baml_py.BamlSyncStream[partial_types.AdherenceRubric, types.AdherenceRubric](
        raw,
