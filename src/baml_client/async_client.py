...
class BamlAsyncClient:
    ...
    async def EvalAdherence(
        self,
        character_description: str,interview: str,
        baml_options: BamlCallOptions = {},
    ) -> types.AdherenceRubric:
      ...
      raw = await self.__runtime.call_function(
        "EvalAdherence",
        {
          "character_description": character_description,"interview": interview,
        },
        self.__ctx_manager.get(),
        tb,
        __cr__,
      )
      return cast(types.AdherenceRubric, raw.cast_to(types, types, partial_types, False))
...
class BamlStreamClient:
    ...
    def EvalAdherence(
        ...
        character_description: str,interview: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[partial_types.AdherenceRubric, types.AdherenceRubric]:
      __tb__ = baml_options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      else:
      ...
      return baml_py.BamlStream[partial_types.AdherenceRubric, types.AdherenceRubric](
        raw,
        lambda x: cast(partial_types.AdherenceRubric, x.cast_to(types, types, partial_types, True)),
        lambda x: cast(types.AdherenceRubric, x.cast_to(types, types, partial_types, False)),
        self.__ctx_manager.get(),
      )
